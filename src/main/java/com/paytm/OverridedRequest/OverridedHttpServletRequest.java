package com.paytm.OverridedRequest;
...
public class OverridedHttpServletRequest implements HttpServletRequest
{
    private HttpServletRequest wrappedRequest;
    private Map<String, String> newParams;
    private Set<String> removedParams;

    public OverridedHttpServletRequest(HttpServletRequest requestToWrap) {
