                ...
                <form action="manageFeed" method="post" id="${ques.question_Id}">
                    <div class="card gedf-card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" style="display:none;" class="cardText" name="ques"
                                   value="${ques.question}" id="selectQues"
                                   onclick="submitByTextbox(${ques.question_Id})"
                                   style="font-size:18pt;border:1px dashed blue;" readonly="true"/>
                                <%--                                </p>--%>
                        </div>
                        <div class="card-footer">
                            <a href="#" class="card-link"><i class="fa fa-gittip"></i> Like</a>
                            <a href="#" onclick="submitByTextbox(${ques.question_Id})" class="card-link"><i
                                    class="fa fa-comment"></i> Answer</a>
