...
<div id="resetPasswordDiv">
    <div class="login-form">
        ...
        <form name="resetForm" action="reset" method="post">
            ...
            <div style="text-align: center;color: blueviolet">Reset password</div>
            <br/>

            <input type="password" id="pswd1" style="width: 80%" placeholder="Enter your new password here"
                   name="updatedPassword"/>
            <input type="button" id="button1" value="Show" onclick="change1()"><br/><br/>

            <input type="password" id="pswd2" style="width: 80%" placeholder="Confirm new password here"
